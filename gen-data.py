...
def gen_data(num_exm, new_size, total_grid_size=256, max_mole_dist=32, max_mole_size=30):
    ...
    for z in range(num_exm):
        ...
        data['grid'].append(avg_grid(grid, total_grid_size , new_size))
...
if __name__ == '__main__':
    ...
    f1['data'] = [padding(data, focus) for data in train_data['grid']]
    ...
    f2['data'] = [padding(data, focus) for data in valid_data['grid']]
    ...
    f3['data'] = [padding(data, focus) for data in test_data['grid']]
